    ...
    <section>
        ...
        <div id="scroll-container">
          ...
          <div class="custom-banner">
            <div class="pictures"><img
                src="imagini scrolabile/Manusi_Box_66b773b3-8b9b-445d-afa4-c87a98c1cf51_1800x.png" alt=""></div>
            <div class="description"></div>
          </div>
          <div class="custom-banner">
      ...
      <div class="logo-container">
        <div class="logo-slides">
          ...
          <a href="#"><img
              src="logo/nike-logo-black-clothes-design-icon-abstract-football-illustration-with-white-background-free-vector.jpg"
              alt=""></a>
